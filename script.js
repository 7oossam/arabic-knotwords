const puzzles = {
    easy: {
        theme: "مدرسة", rows: 3, cols: 4,
        solution: [
            ['م', 'ك', 'ت', 'ب'],
            ['ع', 'ل', 'م', ' '],
            [' ', 'ب', 'ر', ' ']
        ],
        rowClues: ["مكان للدراسة والعمل", "راية أو معرفة", "عكس بحر (اليابسة)"],
        colClues: ["حرف جر بمعنى برفقة", "حيوان أليف وفي ينبح", "فاكهة حلوة من النخيل", "حرف هجائي (ثاني الحروف)"],
        regions: [
            { id: 'r0', cells: [[0,0], [0,1], [1,0], [1,1]], letters: ['م', 'ك', 'ع', 'ل'] },
            { id: 'r1', cells: [[0,2], [0,3], [1,2], [2,1], [2,2]], letters: ['ت', 'ب', 'م', 'ب', 'ر'] }
        ]
    },
    medium: {
        theme: "متنوع", rows: 4, cols: 4,
        solution: [
            ['س', 'م', 'ع', ' '],
            [' ', 'ك', ' ', ' '],
            ['ك', 'ت', 'ا', 'ب'],
        ...
        rowClues: ["حاسة من الحواس الخمس", "حرف هجائي", "خير جليس في الزمان", "دخان ذو رائحة طيبة"],
        colClues: ["حرفان: س و ك", "مكان العمل والموظفين", "أخو الأب أو الأم؟ لا، شقيق", "اليابسة (عكس البحر)"],
        regions: [
            { id: 'r0', cells: [[0,0], [0,1], [1,1], [2,0]], letters: ['س', 'م', 'ك', 'ك'] },
            { id: 'r1', cells: [[0,2], [2,1], [2,2], [3,1]], letters: ['ع', 'ت', 'ا', 'ب'] },
            { id: 'r2', cells: [[2,3], [3,2], [3,3]], letters: ['ب', 'خ', 'ر'] }
        ]
    },
    large: {
        theme: "كلمات", rows: 6, cols: 6,
        solution: [
            ['ق', 'ط', 'ة', ' ', ' ', ' '],
            [' ', 'ي', ' ', ' ', ' ', ' '],
            [' ', 'ر', 'د', ' ', ' ', ' '],
        ...
        rowClues: ["حيوان أليف يحب اللعب", "حرف الياء", "إجابة على سؤال", "حرف الميم، ثم يابسة", "عضو الإبصار في الجسم", "انتهى أو اكتمل"],
        colClues: ["حرف القاف", "حيوان يغطي جسمه الريش", "حرف التاء المربوطة، ثم قطرة ماء من العين", "حرف الياء", "فتاة صغيرة", "حرف الراء والميم"],
        regions: [
            { id: 'r0', cells: [[0,0], [0,1], [1,1], [0,2]], letters: ['ق', 'ط', 'ي', 'ة'] },
            { id: 'r1', cells: [[2,1], [2,2], [3,2], [4,2]], letters: ['ر', 'د', 'م', 'ع'] },
            { id: 'r2', cells: [[3,4], [3,5], [4,4], [4,3]], letters: ['ب', 'ر', 'ن', 'ي'] },
            { id: 'r3', cells: [[5,4], [5,5]], letters: ['ت', 'م'] }
        ]
    }
};
